        ...
        >
            ...
            <div className="container max-w-[1140px] mx-auto">
                <div className="flex flex-col max-xl:justify-center max-xl:items-center lg:pt-[178px] md:pt-[120px] pt-[67px] xl:pl-9 relative z-20">
                    ...
                    <h1
                        className="relative lg:text-custom-xl md:text-5xl text-custom-2md lg:leading-custom-lg sm:leading-custom-2md tracking-custom-sm leading-custom-md [text-shadow:0px_4px_4px_rgba(0,0,0,0.25)] max-xl:text-center font-bold pt-[10px] text-white lg:max-w-[700px] max-w-[450px]"
                    >
