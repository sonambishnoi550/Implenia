    ...
    return (
        <div className='lg:pt-[134px] lg:pb-[128px] md:py-20 py-12'>
            <div className="container">
                ...
                <div className="flex flex-wrap max-xl:justify-center md:gap-[77px] gap-[50px] pt-10 items-center">
                    <div className='flex flex-wrap justify-center md:gap-[61px] gap-[40px]'>
                        <div>
                            <p className='lg:text-[80px] md:text-7xl text-5xl font-normal text-[#FEBE32] max-sm:text-center'><span>+</span>155</p>
                            <p className='font-bold md:text-[21px] text-lg whitespace-nowrap'>Ideas submitted</p>
                        </div>
                        <div>
                            <p className='lg:text-[80px] md:text-7xl text-5xl font-normal text-[#FEBE32] max-sm:text-center'>+325</p>
                            <p className='font-bold md:text-[21px] text-lg whitespace-nowrap'>Active Platform users</p>
                        </div>
                        <div>
                            <p className='lg:text-[80px] md:text-7xl text-5xl font-normal text-[#FEBE32] max-sm:text-center'>+250</p>
