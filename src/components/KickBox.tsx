    ...
    return (
        <div id='stories' className='lg:pt-[134px] lg:pb-[128px] md:py-20 py-12'>
            <div className="container max-w-[1140px] mx-auto px-4">
                ...
                <div className="flex flex-wrap max-xl:justify-center justify-between xl:gap-[92px] md:gap-[67px] gap-[50px] pt-10 items-center">
                    <div
                        ref={ref}
                    ...
                    >
                        {STATS.map((item, index) => (
                            ...
                            >
                                <h3 className="lg:text-custom2Xl md:text-7xl text-5xl font-normal text-dark-orange max-sm:text-center tracking-[-0.66px]">
                                    +
                                    <CountUp
                                        start={0}
                                        end={
