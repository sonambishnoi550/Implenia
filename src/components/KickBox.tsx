    ...
    return (
        <div className='lg:pt-[134px] lg:pb-[128px] md:py-20 py-12'>
            <div className="container max-w-[1140px] mx-auto">
                ...
                <p className='text-left font-light md:text-custom-sm text-base -tracking-custom-xmd leading-custom-2sm lg:pt-4 pt-2 text-light-black max-xl:text-center'>
                ...
                <div className="flex flex-wrap max-xl:justify-center justify-between xl:gap-[92px] md:gap-[67px] gap-[35px] pt-9 items-center">
                    <div
                        ref={ref}
                    ...
                    >
                        {COUNT_LIST.map((item: CountItem, index: number) => (
                            ...
                            >
                                ...
                                <p className="font-bold md:text-custom-sm text-lg whitespace-nowrap leading-custom-sm">
                                    {item.label}
                                </p>
                            </div>
                        ))}
                    </div>
                    <CustomButton text="Submit Your idea!" myClass='md:!px-[43px] !px-5 !py-3' />
                </div>
            </div>
        </div>
    );
